...
function Forma() {
  ...
  const [svgFillColorBackNumberName, setSvgFillColorBackNumberName] =
    useState('white');
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('backnamenumber', svgFillColorBackNumberName);
  ...
  function handleButtonClickBackNumberName(color) {
    setSvgFillColorBackNumberName(color);
  }
...
<div className="flex md:flex-row flex-col gap-y-10 items-center justify-center md:gap-x-10  p-20">    <div >
    {toggle ? (
        <div className="w-80">
          <BackDesign
            ...
            onFillNumerName={svgFillColorBackNumberName}
    ...
    <div className='w-1/3 h-max  bgpost '>
    <ChooseColor
        onChooseFormaDesign={handleButtonClickFormaDesign}
        onChooseBack={handleButtonClickBackNumberName}
